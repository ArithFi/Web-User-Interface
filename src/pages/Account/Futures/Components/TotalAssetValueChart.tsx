...
const ReCharts: FC<ChartsProps> = ({...props}) => {
  ...
  const {data} = useSWR(`https://db.arithfi.com/dashboardapi/dashboard/v2/personal/asset?address=${props.address}&chainId=${chainsData.chainId ?? 56}&from=${from}&to=${to}&copy=0`,
