...
const ReCharts: FC<ChartsProps> = ({...props}) => {
  ...
  const {data} = useSWR(`https://db.arithfi.com/dashboardapi/dashboard/v2/personal/yield?address=${props.address}&chainId=${chainsData.chainId ?? 56}&from=${from}&to=${to}&copy=0`,
