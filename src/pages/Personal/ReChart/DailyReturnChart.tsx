    ...
    <Stack width={'100%'} height={'100%'}>
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Bar dataKey="get" barSize={20} fill={nowTheme.normal.success} unit={' ATF'} minPointSize={1} stackId={'a'}/>
          <Bar dataKey="loss" barSize={20} fill={nowTheme.normal.danger} unit={' ATF'} stackId={'a'}/>
        </ComposedChart>
      </ResponsiveContainer>
    </Stack>
  )
