...
import KolItem, {KolItemSkeleton} from "./Components/kolItem";
...
const Copy: FC = () => {
      ...
      return (
        ...
        >
          <Stack spacing={"24px"}>
            ...
            >
              {myTradeInfo(
                t`Copy Trading Total Amount (ATF)`,
  ...
  }, [allPage, kolList, setPage, isKOLListLoading]);
