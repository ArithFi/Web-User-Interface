  ...
  return (
    <Stack alignItems={"center"}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {t`Deflationary economic model. The more users trade, the more $ATF will be burned.`}
            </Box>
          </Stack>
          <Stack
            pb={["32px", "40px", "80px"]}
          ...
          {width > WidthType.lg ? (
            ...
            >
              {[
                {
                  title: t`Total Trading Volume (ATF)`,
                  value: txInfo
      ...
      {width <= WidthType.md && chainsData.chainId !== 534353 && (
        ...
        >
          <Box>{t`Join ArithFi affiliate program and get commission on your referrals.`}</Box>
          <MainButton
            title={t`Join`}
            style={{
              width: "125px",
      ...
      >
        {width >= WidthType.lg && chainsData.chainId !== 534353 && (
          ...
          >
            ...
            >
              ...
              >
                <Trans>
                  Join ArithFi affiliate program and get commission on your
                  referrals.
                </Trans>
              </Box>
              <MainButton
        ...
        >
          <Stack maxWidth={"1600px"} width={"100%"}>
            ...
            >
              {t`Why You Should Choose ArithFi`}
            </Box>
            <Stack
              direction={"row"}
              pt={["20px", "20px", "40px"]}
              ...
              <Grid container spacing={"24px"}>
                {[
                  ...
                  },
                  {
                    ...
                    description: t`ATF's economic model is deflationary. The more users trade, the more $ATF will be burned.`,
                  },
                  {
                    icon: <HomeIcon3 />,
                  ...
                  },
                  {
                    ...
                    description: t`The smart contract guarantees infinite liquidity through burning and issuing $ATF.`,
                  },
                ].map((item, index) => {
                  return (
        ...
        >
          ...
          >
            <Stack spacing={"12px"}>
              ...
              >
                {t`A beginner's guide to using ArithFi`}
              </Box>
            </Stack>
            <Stack
              ...
              {[
                {
                  ...
                  description: t`Trade BTC, ETH and BNB with up to 1-50 leverage. Open a position with ATF.`,
                ...
                },
                {
                  ...
                  description: t`ArithFi's new features enable you to open a position with a single click.`,
                ...
                },
                {
                  ...
                  description: t`Boost your earning and influence by joining the ArithFi affiliate program.`,
                  link: "",
                },
              ].map((item, index) => (
                <Stack
